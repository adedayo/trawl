...
// 1.26.6 carries fixes for six stdlib vulnerabilities that govulncheck reports
// as reachable from this program. CI installs from this file, so the floor here
// is what every released binary is built with, not just a local preference.
go 1.26.6

require (
	github.com/adedayo/checkmate v1.5.0
	github.com/adedayo/vantage v1.6.0
